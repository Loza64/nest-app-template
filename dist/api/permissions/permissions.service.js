...
let PermissionsService = class PermissionsService {
    ...
    async findBy(params) {
        const result = await (0, nestjs_typeorm_paginate_1.paginate)(this.permissionRepo, { page: params.page, limit: params.size }, { where: params.filters, relations: params.relations });
